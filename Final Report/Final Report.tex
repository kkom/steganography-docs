...
\cref{tab:random_sentence_statistics} shows statistics of sample sentences generated using at least 2048 random bits (the output is continued until the end of the current sentence is reached). Perplexity of a fragment of text consisting of $M$ tokens is defined as $- \frac {1}{M} \log_2 P(w_1^M)$, and can be interpreted as the expected negative log probability of a token. Note that sample size is too small for the differences in average sentence length to be statistically significant.

\begin{table}[h]
	\centering
	\begin{tabular}{ c | c | c || c | c}
	$\beta$ & $\gamma$ & $F$ & Perplexity & Av.\ sentence length \\
	\hline
	1 & 0.01 & 39 & 5.5 & 20 \\
	0.5 & 0.05 & 39 & 5.3 & 21 \\
	0.1 & 0.01 & 39 & 4.1 & 20 \\ \hline
	1 & 0.01 & 35 & 6.1 & 24 \\
	0.5 & 0.05 & 35 & 5.6 & 20 \\
	0.1 & 0.01 & 35 & 4.3 & 18 \\ \hline
	1 & 0.01 & 25 & 5.5 & 27 \\
	0.5 & 0.05 & 25 & 5.4 & 17 \\
	0.1 & 0.01 & 25 & 3.8 & 18 \\ \hline
	1 & 0.01 & 10 & 6.0 & 21 \\
	0.5 & 0.05 & 10 & 5.3 & 20 \\
	0.1 & 0.01 & 10 & 3.9 & 20 \\ \hline
	1 & 0.01 & 0 & 6.1 & 26 \\
	0.5 & 0.05 & 0 & 5.8 & 20 \\
	0.1 & 0.01 & 0 & 4.3 & 22
	\end{tabular}
...
\subsection{Perplexity as a measure of stegotext storage capability}
