...
In this section I will present the results of my project. I have implemented the full language model I designed in \cref{sec:language_model} along with the secure stegosystem from \cref{sec:secure_stegosystem}.
...
I used \iid uniform bits generated by Python's \texttt{random.SystemRandom} class as $\mathcal I$. The longer the input sequence, the longer the output sequence.
