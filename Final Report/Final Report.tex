...
\begin{tikzpicture}[scale=0.5]
	...
	% Label the levels
	\node[below] at (9,-3) {\footnotesize level 1};
	\node[below] at (12,-3) {\footnotesize level 2};
	\node[below] at (15,-3) {\footnotesize level 3};
	\node[below] at (18,-3) {\footnotesize level 4};
	\node[below] at (21,-3) {\footnotesize level 5};
