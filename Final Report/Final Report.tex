...
\section{Language model with back-off}

\subsection{Requirements}

Describe the requirements: need to assign non-zero probability to every token -- need to use back-off, each token needs to be assigned a contiguous probability region -- makes back-off more complicated, need to use exactly 100\% of the probability mass.
