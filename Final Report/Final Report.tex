...
In this project I will take an information theoretic approach to steganography. Plaintext and covertext will be modelled by stochastic processes. I will then adapt an algorithm for discrete pseudo-random number generation to generate stegotext from covertext in a pseudo-random fashion.

\cref{sec:snlm,sec:processing_ngrams,sec:language_model} show how text can be modelled as the output of a stochastic process and how to efficiently estimate the statistics of this process. \cref{sec:interval_algorithm,sec:stegosystem} describe how to construct a stegosystem using this language model.
