...
\newcommand{\connectedVertex}[4] {
	\draw [shorten >= 0.5*(\vertexSize+\pgflinewidth), shorten <= 0.5*(\vertexSize+\pgflinewidth), ->] (#1,#2) to [bend left=12.5] (#3,#4);
...
\begin{tikzpicture}[scale=0.5]
	...
	\rootVertex{6}{9.5}
	\node[left] at (5.5,9.5) {\footnotesize root};

	% First level word leaves
	\connectedLeaf{6}{9.5}{9}{-1}{right}
	\connectedLeaf{6}{9.5}{9}{0}{right}
	\connectedLeaf{6}{9.5}{9}{1}{right}

	% First level backoff node
	\connectedVertex{6}{9.5}{9}{11}


	% Second level word leaves
	\connectedLeaf{9}{11}{12}{2}{right}
	\connectedLeaf{9}{11}{12}{3}{right}
	\connectedLeaf{9}{11}{12}{4}{right}
	\connectedLeaf{9}{11}{12}{5}{right}

	% Second level backoff node
	\connectedVertex{9}{11}{12}{13}


	% Third level word leaves
	\connectedLeaf{12}{13}{15}{6}{right}
	\connectedLeaf{12}{13}{15}{7}{right}

	% Third level backoff node
	\connectedVertex{12}{13}{15}{14}


	% Fourth level word leaves
	\connectedLeaf{15}{14}{18}{8}{right}
	\connectedLeaf{15}{14}{18}{9}{right}
	\connectedLeaf{15}{14}{18}{10}{right}
	\connectedLeaf{15}{14}{18}{11}{right}
	\connectedLeaf{15}{14}{18}{12}{right}

	% Fourth level backoff node
	\connectedVertex{15}{14}{18}{16.5}


	% Fifth level word leaves
	\connectedLeaf{18}{16.5}{21}{13}{right}
	\connectedLeaf{18}{16.5}{21}{14}{right}
	\connectedLeaf{18}{16.5}{21}{15}{right}
	\connectedLeaf{18}{16.5}{21}{16}{right}
	\connectedLeaf{18}{16.5}{21}{17}{left}
	\connectedLeaf{18}{16.5}{21}{18}{left}
	\connectedLeaf{18}{16.5}{21}{19}{left}
	\connectedLeaf{18}{16.5}{21}{20}{left}

	% Draw the intervals and the dashed line showing correspondence to leaves
	\draw[dashed] [shorten >= 1.5 pt] (21,20.5) -- (24,20.5);
	\draw[solid] [i] (24,12.5) -- (24,20.5);
	\draw[dashed] (18,12.5) -- (24,12.5);
	\draw[solid] [i] (24,7.5) -- (24,12.5);
	\draw[dashed] (15,7.5) -- (24,7.5);
	\draw[solid] [i] (24,5.5) -- (24,7.5);
	\draw[dashed] (12,5.5) -- (24,5.5);
	\draw[solid] [i] (24,1.5) -- (24,5.5);
	\draw[dashed] (9,1.5) -- (24,1.5);
	\draw[solid] [i] (24,-1.5) -- (24,1.5);
	\draw[dashed] (9,-1.5) -- (24,-1.5);

	% Label the intervals
	\node[above] at (24,20.5) {\footnotesize 1};
	\node[below] at (24,-1.5) {\footnotesize 0};

	% Label the levels
	\node[below] at (9,-3) {\footnotesize level 0};
	\node[below] at (12,-3) {\footnotesize level 1};
	\node[below] at (15,-3) {\footnotesize level 2};
	\node[below] at (18,-3) {\footnotesize level 3};
	\node[below] at (21,-3) {\footnotesize level 4};
